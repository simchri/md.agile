...
between tasks across your whole workspace, without manually opening files.
...
out of the box once the server advertises the capability — no custom
keymap/config needed beyond registering the server itself.
...
vim.keymap.set("n", "<leader>jh", mdagile_jump("mdagile.jump.highestPriorityOpen", false))
vim.keymap.set("n", "<leader>jm", mdagile_jump("mdagile.jump.highestPriorityMy", false))
vim.keymap.set("n", "]t", mdagile_jump("mdagile.jump.nextOpen", true))
vim.keymap.set("n", "[t", mdagile_jump("mdagile.jump.previousOpen", true))
vim.keymap.set("n", "]T", mdagile_jump("mdagile.jump.nextMy", true))
vim.keymap.set("n", "[T", mdagile_jump("mdagile.jump.previousMy", true))
```
