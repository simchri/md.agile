...
- [Never edit user's tasks](feedback_no_task_edits.md) — only permitted change to tasks.agile.md is ticking a completed task to `[x]`; never reword, add/remove markers (e.g. #OPT), or restructure without explicit request
